...
const ListForm = () => {
   ...
   // DISABLE EDITING WHEN ESCAPE KEY IS DISABLED
    ...
    return (
        <ListWrapper>
            <form ref={formRef} className="w-full p-3 rounded-md bg-white space-y-4 shadow-md">
              <FormInput ref={inputRef} id="title"className="text-sm px-3 py-1 h-7 font-medium
              border-transparent hover:border-input focus:border-input transition"
              placeholder="Enter list title..."/>
              <input onChange={() => {}} hidden value={params.boardId} name="boardId"/>
